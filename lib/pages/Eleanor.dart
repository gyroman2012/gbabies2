...
import 'package:firephotogallery/galleries/EleanorGallery.dart';
import 'package:flutter/material.dart';

class EleanorUploadScreen extends StatefulWidget {
  @override
  _EleanorUploadScreenState createState() => _EleanorUploadScreenState();
}

class _EleanorUploadScreenState extends State<EleanorUploadScreen> {
  ...
  uploadFileToStorage(File file) {
    UploadTask task = _firebaseStorage
        .ref()
        .child("eleanor/${DateTime.now().toString()}")
        .putFile(file);
    return task;
  }
          ...
          IconButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => EleanorGalleryScreen()));
              })
        ],
      ),
